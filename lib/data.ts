...
export const BIKES: Bike[] = [
  { id: 'lil-hustler', name: 'Built to order: Lil\' Hustler Minibike', shortName: 'Lil Hustler', color: '#e8b800', description: 'The original handcrafted NZ classic.', price: 2490, image: '/pictures/bike.jpeg', images: ['/pictures/bike.jpeg', '/pictures/bike-side-view.jpeg', '/pictures/bike1.jpeg', '/pictures/bike1-compplete-view.jpeg', '/pictures/bike1-back-view.jpeg'] },
  { id: 'hustler-v200-chopper', name: 'Hustler V200 Chopper', shortName: 'Hustler Customs', color: '#8B2FC9', description: 'Beast on wheels with extra grip.', price: 18000, image: '/pictures/purple-bike.jpeg', images: ['/pictures/purple-bike.jpeg', '/pictures/purple-bike-side-view.jpeg', '/pictures/purple-bike-back-view.jpeg'] },
  { id: 'hustler-badboy-chopper', name: 'Built to order: Hustler Badboy Chopper', shortName: 'Hustler Badboy Chopper', color: '#c0392b', description: 'A timeless vintage stance.', price: 8775, image: '/pictures/color-bike.jpeg', images: ['/pictures/color-bike.jpeg', '/pictures/color-bike-side-view.jpeg', '/pictures/color-bike-engine-view.jpeg', '/pictures/color-bike-back-view.jpeg'] },
  { id: 'hustler-fatboy', name: 'Built to order: Hustler Fatboy', shortName: 'Hustler Fatboy', color: '#2c7a4b', description: 'Born to run wild and free.', price: 4990, image: '/pictures/orange-bike-top-view.jpeg', images: ['/pictures/orange-bike-top-view.jpeg', '/pictures/orange-bike-front-view.jpeg'] },
];
